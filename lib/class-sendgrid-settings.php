...
class Sendgrid_Settings {
	...
	public static function add_settings_menu()
	{
		...
		/**
		 * Adds conteztual_help when this admin page loads
		 */
		add_action( 'load-'.$sgAdminPage, array(__CLASS__, 'show_contextual_help') );
	}
